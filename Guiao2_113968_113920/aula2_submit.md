...
```
Relação Binária Produto-Encomenda -> Many-to-Many Mandatory
Relação Binária Encomenda-Fornecedor -> 1-to-Many Mandatory
Relação Binária Tipo-Fornecedor Fornecedor -> 1-to-Many Mandatory
